...
Deterministische Dateityp-Erkennung und sichere Archiv-Verarbeitung (u. a. für ZIP/TAR/GZIP/7z/RAR) mit fail-closed Verhalten.
...
- Die aktuelle Semantik ist archivformat-generisch: validiert/extrahiert werden intern alle unterstützten Archivformate (z. B. ZIP/TAR/GZIP/7z/RAR) fail-closed.
- Begriffsklärung: `ContainerType` bezeichnet das physische Archivformat; der logische Rückgabetyp bleibt aus Kompatibilitätsgründen `FileKind.Zip`.

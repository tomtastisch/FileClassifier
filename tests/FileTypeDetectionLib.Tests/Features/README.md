...
| `FTD_BDD_040_ARCHIVE_TYPEN_BYTEARRAY_UND_MATERIALISIERUNG.feature` | Einheitliches Byte-Array-Verhalten fuer Archivformate (ZIP/TAR/TAR.GZ/7z/RAR) bei Detect/Validate/Extract/Materialize | `@integration`, `@archive`, `@processing`, `@materializer`, `@positiv` |

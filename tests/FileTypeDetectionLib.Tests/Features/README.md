...
| `FTD_BDD_040_ARCHIVE_TYPEN_BYTEARRAY_UND_MATERIALISIERUNG.feature` | Einheitliches Byte-Array-Verhalten fuer ZIP/TAR/TAR.GZ/7z/RAR (Detect/Validate/Extract/Materialize) | `@integration`, `@archive`, `@processing`, `@materializer`, `@zip`, `@positiv` |
| `FTD_BDD_050_DETERMINISTISCHES_HASHING_UND_ROUNDTRIP.feature` | Deterministische Hash-Evidence und h1-h4 RoundTrip-Nachweis fuer Archive und direkte Dateien | `@e2e`, `@hashing`, `@deterministic`, `@roundtrip`, `@positiv` |

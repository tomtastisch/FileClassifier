...
Funktionalität: Unit-nahe API-Detektion und Policy-Verhalten
  ...
  @positiv @negativ @endung @detector
  ...
  @positiv @negativ @typpruefung @detector
  ...
  @positiv @konfiguration @processing

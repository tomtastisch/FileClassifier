<!-- LANG_SWITCH:BEGIN -->
[DE](001_NETSTANDARD2_POLICY_SNAPSHOT.MD) | [EN](../../../1_en/audit/compat/001_NETSTANDARD2_POLICY_SNAPSHOT.MD)
<!-- LANG_SWITCH:END -->

# Policy Snapshot: netstandard2 Compat Refactor

## 1. Zweck
Dieses Dokument extrahiert verbindliche Anforderungen für den netstandard2.0-Kompatibilitätsrefactor.
...
- Keine Public-Signaturänderungen und kein Behavior-Drift in bestehenden Public APIs.
- Build/Test müssen erfolgreich sein.
...
- Dokumentdateien unter `docs/` müssen `UPPER_SNAKE_CASE` mit `.MD` nutzen.
...
- Interne Abstraktionen für TFM-sensitive APIs sind erlaubt.
...
Auszüge der Policyquellen:
- `docs/governance/045_CODE_QUALITY_POLICY_DE.MD:36-39` (keine Semantikänderung, keine Signaturänderung)
- `docs/governance/045_CODE_QUALITY_POLICY_DE.MD:196-204` (DoD Build/Test, keine Public-Signature-Änderung)
...
- Keine Einführung neuer externer Runtime-Abhängigkeiten ausser zur Kompatibilität notwendige Library-Referenzen.

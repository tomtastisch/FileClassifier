...
- Changed:
  ...
  - Release-Retention (`tools/ci/release/retention_apply.sh`) so angepasst, dass nach vorhandenem Stable-Tag keine RC-Version mehr als Keep-Set erhalten bleibt.
- Fixed:

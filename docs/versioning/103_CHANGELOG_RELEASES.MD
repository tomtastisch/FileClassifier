...
- Changed:
  ...
  - Updated release retention (`tools/ci/release/retention_apply.sh`) so RCs for an already released stable base version are cleaned up, while the latest RC of a higher upcoming version is kept.
- Fixed:

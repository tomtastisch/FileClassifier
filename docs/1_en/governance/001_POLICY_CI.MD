<!-- LANG_SWITCH:BEGIN -->
[DE](../../0_de/governance/001_POLICY_CI.MD) | [EN](001_POLICY_CI.MD)
<!-- LANG_SWITCH:END -->
...
The detailed job DAG and contract matrix are maintained in `docs/ci/101_PIPELINE_CI.MD` to avoid duplication.

## Rule Catalog
- Rule IDs and file ownership are indexed in `docs/governance/106_INDEX_CI_RULES.MD`.

...
## 3. Playbooks
1. [Playbook: Options anlegen und anpassen](https://github.com/tomtastisch/FileClassifier/blob/241c6d4/docs/guides/001_GUIDE_OPTIONS.MD)
2. [Playbook: Neue Datatypes und API-Modelle erweitern](https://github.com/tomtastisch/FileClassifier/blob/241c6d4/docs/guides/002_GUIDE_DATATYPE.MD)
...
## 5. Verknüpfungen
- [Doku-Index](https://github.com/tomtastisch/FileClassifier/blob/241c6d4/docs/001_INDEX_CORE.MD)
